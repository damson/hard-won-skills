...
Five skills for one failure: trusting a signal nobody has checked. One makes
...
attempt has usually failed to contain the case; the last is for the moment a
signal and reality disagree, and sends you to the authoritative record before
you debug work that was never broken.
